...
public class WebSocketClientHandler extends SimpleChannelInboundHandler<Object> {
    ...
    public WebSocketClientHandler(WebSocketClientHandshaker handshaker,WebSocketTextMessageHandler textMessageHandler) {
    ...
    public void channelRead0(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (frame instanceof TextWebSocketFrame) {
            ...
            // 此处在接受到消息后进行序列化转换
            textMessageHandler.onMessage(textFrame.text(), NettyMessageConnection.create(ctx));
