...
import cc.catman.coder.workbench.core.label.equal.EndWithLabelSelector;
import com.fasterxml.jackson.databind.JsonNode;

public class EndWithLabelSelectorCreator extends AbstractLabelSelectorCreator{
    @Override
    protected AbstractLabelSelector<?> doCreate(JsonNode jsonNode, ILabelSelectorFactory factory) {
        return EndWithLabelSelector.builder()
