...
import cc.catman.coder.workbench.core.label.equal.NotEmptyLabelSelector;
import com.fasterxml.jackson.databind.JsonNode;

public class NotEmptyLabelSelectorCreator extends AbstractLabelSelectorCreator{
    @Override
    protected AbstractLabelSelector<?> doCreate(JsonNode jsonNode, ILabelSelectorFactory factory) {
        return NotEmptyLabelSelector.builder().build();
    }
}
