...
import cc.catman.coder.workbench.core.value.Switch.SwitchValueProviderConfig;
 ...
 */
@Service
public class SwitchValueProviderServiceImpl extends AbstractValueProviderServiceImpl<SwitchValueProviderConfig, SwitchValueProvider> {
